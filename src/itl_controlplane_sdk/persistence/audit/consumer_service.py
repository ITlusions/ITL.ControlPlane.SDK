...
Usage:
    # Direct execution
    python -m itl_controlplane_sdk.persistence.audit.consumer_service
...
async def create_handlers():
    ...
    from itl_controlplane_sdk.persistence.audit.models import AuditAction
...
async def main():
    """Main entry point."""
    from itl_controlplane_sdk.persistence.audit import RabbitMQConsumer
