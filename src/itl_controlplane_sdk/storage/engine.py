...
class SQLAlchemyStorageEngine:
    ...
    Configuration via environment variables:
        STORAGE_BACKEND     — "postgresql" (default) or "sqlite"
        DATABASE_HOST       — PostgreSQL host
        DATABASE_PORT       — PostgreSQL port  
        DATABASE_NAME       — Database name
        DATABASE_USER       — Database user
        DATABASE_PASSWORD   — Database password
        NEO4J_URI           — Neo4j bolt URI (optional, enables sync)
        ...
        try:
            ...
            if neo4j_uri:
                ...
                if neo4j_ok:
                    ...
                    logger.warning("Neo4j sync connection failed — running without sync")
    ...
    # ===================================================================
    # Repository factories — create repo instances for a given session
    # ===================================================================
