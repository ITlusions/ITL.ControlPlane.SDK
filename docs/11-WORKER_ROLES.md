...
- [08-API_ENDPOINTS.md](features/api-endpoints.md) - FastAPI integration
- [06-HANDLER_MIXINS.md](features/handler-mixins.md) - Handler patterns
- [07-LOCATION_VALIDATION.md](features/location-validation.md) - Validation
