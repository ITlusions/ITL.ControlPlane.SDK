...
## 1 User Initiates Create Request
...
## 2 Schema Validation (ValidatedResourceHandler)
...
## 3 Uniqueness Check (ScopedResourceHandler)
...
## 4 Generate Resource ID (ResourceGroupHandler Override)
...
## 5 Add Automatic Timestamps (TimestampedResourceHandler)
...
## 6 Initialize Provisioning State (ProvisioningStateHandler)
...
## 7 Store in Dictionary (ScopedResourceHandler)
